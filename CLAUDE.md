...
| `frontend-builder` | 정적 HTML/CSS/JS 구현 | **Edit/Write/Bash (유일)** | static-page-builder, design-system-application | 코드 수정 |
...
| 스킬 | 용도 | 주 사용자 |
| --- | --- | --- |
| `web-team` | 팀 가동 오케스트레이션 절차 전체 | 오케스트레이터 |
...
- 페이지 산출물은 `site/index.html`, `site/styles.css`, `site/app.js` 세 파일뿐입니다.
- 새 파일·폴더·프레임워크·빌드 도구·CDN을 추가하지 않습니다. `open site/index.html`만으로 동작해야 합니다.
